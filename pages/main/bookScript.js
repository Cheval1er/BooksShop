...
// let jsCartItem = document.createElement("div");
// jsCartItem.classList.add("cart-item", "cart-column");

// let cartImg = document.createElement("img");
// cartImg.setAttribute("class", "cart-item-image");
// cartImg.src = books[0].imageLink;
// cartImg.alt = "alt";
// cartImg.width = 100;
// cartImg.height = 100;
// jsCartItem.appendChild(cartImg);


// let cartItemTitle = document.createElement("span");
// cartItemTitle.setAttribute("class", "cart-item-title");
// let cartItemTitleText = document.createTextNode(books[0].author + " - " + books[0].title);
// cartItemTitle.appendChild(cartItemTitleText);
// jsCartItem.appendChild(cartItemTitle);
// jsCartRow.appendChild(jsCartItem);

// let jsCartPrice = document.createElement("span");
// jsCartPrice.classList.add("cart-price", "cart-column");
// let jsCartPriceText = document.createTextNode("$" + books[0].price);
// jsCartPrice.appendChild(jsCartPriceText);
// jsCartRow.appendChild(jsCartPrice);

// let jsCartQuantity = document.createElement("div");
// jsCartQuantity.classList.add("cart-quantity-input","cart-column" );



// let cartInput = document.createElement("input");
// cartInput.setAttribute("class", "cart-quantity-input-input");
// cartInput.setAttribute("type", "number");
// cartInput.setAttribute("value", "1");
// jsCartQuantity.appendChild(cartInput);
...
// jsCartQuantity.appendChild(removeButton);



// jsCartRow.appendChild(jsCartQuantity);

// addedItem.appendChild(jsCartRow);

// let jsCartRow1 = document.createElement("div");
// jsCartRow1.setAttribute("class", "cart-row");
// addedItem.appendChild(jsCartRow1);
// cartSection.appendChild(addedItem);

// let jsCartItem1 = document.createElement("div");
// jsCartItem1.classList.add("cart-item", "cart-column");

// let cartImg1 = document.createElement("img");
// cartImg1.setAttribute("class", "cart-item-image");
// cartImg1.src = books[1].imageLink;
// cartImg1.alt = "alt";
// cartImg1.width = 100;
// cartImg1.height = 100;
// jsCartItem1.appendChild(cartImg1);


// let cartItemTitle1 = document.createElement("span");
// cartItemTitle1.setAttribute("class", "cart-item-title");
// let cartItemTitleText1 = document.createTextNode(books[1].author + " - " + books[1].title);
// cartItemTitle1.appendChild(cartItemTitleText1);
// jsCartItem1.appendChild(cartItemTitle1);
// jsCartRow1.appendChild(jsCartItem1);

// let jsCartPrice1 = document.createElement("span");
// jsCartPrice1.classList.add("cart-price", "cart-column");
// let jsCartPriceText1 = document.createTextNode("$" + books[1].price);
// jsCartPrice1.appendChild(jsCartPriceText1);
// jsCartRow1.appendChild(jsCartPrice1);

// let jsCartQuantity1 = document.createElement("div");
// jsCartQuantity1.classList.add("cart-quantity-input","cart-column" );



// let cartInput1 = document.createElement("input");
// cartInput1.setAttribute("class", "cart-quantity-input-input");
// cartInput1.setAttribute("type", "number");
// cartInput1.setAttribute("value", "1");
// jsCartQuantity1.appendChild(cartInput1);

// let removeButton1 = document.createElement("button");
// removeButton1.classList.add("btn", "btn-danger");
// removeButton1.setAttribute("type", "button");

// let removeText1 = document.createTextNode ("Remove");
// removeButton1.appendChild(removeText1);
// jsCartQuantity1.appendChild(removeButton1);



// jsCartRow1.appendChild(jsCartQuantity1);
...
deliveryButton.setAttribute("href", "../form page/form.html");
deliveryButton.setAttribute("onclick","window.location.href = '../form page/form.html'");
